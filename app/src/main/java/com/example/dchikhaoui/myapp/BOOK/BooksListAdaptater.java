...
import com.example.dchikhaoui.myapp.databinding.ItemBookAdaptaterBinding;
...
public class BooksListAdaptater extends RecyclerView.Adapter<BooksListAdaptater.BookHolder> {
    ...
    public void onBindViewHolder(final BookHolder holder, int position) {
        ...
        holder.feedItemBinding.setBookPresenter(new BookPresenter(mListBooks));
    }
    ...
    public ArrayList<books> getmListBooks() {
        return mListBooks;
    }
